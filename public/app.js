...
function renderRegister() {
  app.innerHTML = `
    <div class="content-stack">
      <div>
        <h2 class="heading-xl">Descubra sua cortesia especial</h2>
        <p class="subtitle">Responda 3 perguntas rápidas, descubra seu perfil de mãe e revele sua surpresa.</p>
      </div>
  ...
  app.innerHTML = `
    <div class="content-stack gift-stack">
      <div class="centered">
        ...
        <p class="subtitle">Sua escolha é única. Clique em uma das três opções para revelar sua cortesia.</p>
      </div>
...
function renderPrize() {
  const text = encodeURIComponent(`Oi, tudo bem? Eu participei da promoção de Dia das Mães do Buffet Biruta Park, fui identificada como ${state.profileName} e ganhei a cortesia ${state.prize}. Gostaria de saber como utilizar meu prêmio.`);
  app.innerHTML = `
    <div class="result-card centered" style="position:relative; overflow:hidden;">
      ${confettiHtml()}
      <div class="spark-badge">🎁</div>
      ...
      <div class="button-stack">
        ...
        <button class="ghost-btn" id="restartBtn">Voltar ao início</button>
      </div>
    </div>`;
